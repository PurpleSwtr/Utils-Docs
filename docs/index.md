...
!!! note "Почитать о том что и как я делаю можно в этом же разделе на главной страничке"
    ...
    Уже сейчас я развернул [это приложение](root/mkdocs_plugins/app_plugin/) через Docker на локальной машине, и регулярно пользуюсь им для быстрого пополнения базы знаний.
